...
<p align="center">
  ...
  <em>Tidak untuk penggunaan operasional, komersial, atau distribusi publik.</em>
</p>
...
Proyek ini **tidak stabil**, **belum siap produksi**, dan mungkin mengalami perubahan struktur secara besar-besaran di setiap commit.
...
- Anda **tidak akan menggunakan** kode, ide, modul, atau komponennya untuk aktivitas yang melanggar hukum.  
- Pengembang **tidak bertanggung jawab** atas penyalahgunaan apa pun yang dilakukan pihak eksternal.  
- Penulis **tidak menyediakan dukungan**, **tidak menerima kontribusi publik**, dan **tidak mengizinkan distribusi ulang** dalam bentuk apa pun.

> **Jika Anda menemukan repository ini secara tidak sengaja, harap tinggalkan tanpa menyalin atau menggunakan kode di dalamnya.**
...
- [ ] Modul telemetri eksperimen  
- [ ] Dashboard internal (private)  
- [ ] Sistem plugin internal  
- [ ] Dokumentasi teknis mendalam  

*(Roadmap ini tidak final dan dapat berubah kapan saja.)*
...
[Peju3ncer](https://github.com/Peju3ncer) & Kawan-kawan dari **I.W.I (Identity Without Identity)**
...
<div align="center">
  <sub><em>© 2025 – Private Research Project</em></sub>
</div>
